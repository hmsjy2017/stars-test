...
- [crisdosyago/discohash](https://github.com/crisdosyago/discohash) - :dancers: Discohash - A super fast and simple hash. 5GB/s serial (depending on hardware). Also in NodeJS
...
- [fbsage/GrabCut-BorderMatting](https://github.com/fbsage/GrabCut-BorderMatting) - Interactive image segmentation platform to separate the foreground and background of the image based on user-speciﬁed bounding box based on grabcut algorithm and border matting algorithm..
...
- [AkaraChen/hexo-theme-cards](https://github.com/AkaraChen/hexo-theme-cards) - Another Simple & Swift theme for Hexo
...
- [TelegramCN/TelegramCN.github.io](https://github.com/TelegramCN/TelegramCN.github.io) - Telegram Web 本地化
...
- [taoso/webfeed](https://github.com/taoso/webfeed) - WebFeed Extension
...
- [xiaoquisme/blogs](https://github.com/xiaoquisme/blogs) - 支持markdown, ascii doctor 两种文件格式自动渲染,自动生成readme,集成github action + github page. 为了更好的体验,请访问 https://blogs.xiaoquisme.com
...
- [iblh/opaque](https://github.com/iblh/opaque) - Simple homepage for your browser.
...
- [YangChengxxyy/cloudreve_flutter](https://github.com/YangChengxxyy/cloudreve_flutter) - 使用Flutter编写的移动端
...
- [Zeta-qixi/MCBE-Server-Docker](https://github.com/Zeta-qixi/MCBE-Server-Docker) - Minecraft 基岩版服务器(MCBE)  使用docker 一键开服
- [HalcyonAzure/lsky-pro-docker](https://github.com/HalcyonAzure/lsky-pro-docker) - ☁️兰空图床(Lsky Pro) - Docker自动构建
- [knatnetwork/github-runner](https://github.com/knatnetwork/github-runner) - Simple Self-Hosted GitHub Actions Runner
- [lyj0309/pan](https://github.com/lyj0309/pan) - cloudreve自动部署至railway.app
- [danielguerra69/ubuntu-xrdp](https://github.com/danielguerra69/ubuntu-xrdp) - Docker fully implemented Multi User xrdp with xorgxrdp and pulseaudio on Ubuntu 16.04/18.04
...
- [xtexChooser/hexo-theme-flavor](https://github.com/xtexChooser/hexo-theme-flavor) - A simple theme for Hexo
...
- [hooke007/MPV_lazy](https://github.com/hooke007/MPV_lazy) - 🔄 mpv player 播放器折腾记录 windows conf ； 中文注释配置 快速帮助萌新入门 ； mpv-lazy 懒人包 win10 x64
...
- [AH-dark/Anchor](https://github.com/AH-dark/Anchor) - Self-built proxy system for GitHub repositories, NPM packages, and WordPress themes and plugins.
- [RicheyJang/PaimengBot](https://github.com/RicheyJang/PaimengBot) - 派蒙Bot：一个使用Onebot协议、基于ZeroBot的QQ娱乐机器人，支持30余种功能，可以大大丰富你的QQ体验或群活跃度，欸嘿。支持多种数据库（包括SQLite、Postgresql、Mysql等）
...
- [0xJacky/ipsw-go](https://github.com/0xJacky/ipsw-go) - 
...
- [AH-dark/random-donate](https://github.com/AH-dark/random-donate) - V我50，为你一辈子做牛做马
...
- [monero-ecosystem/telegram-monerotipbot](https://github.com/monero-ecosystem/telegram-monerotipbot) - This is the repository of the Monero tip bot for Telegram. The one and only, first Monero wallet for Telegram.
...
- [haoxie666/HxMinerProxy](https://github.com/haoxie666/HxMinerProxy) - HXMinerProxy/ETH/ETC/BTC/BCH/CFX/RVN/ERG/LTC/SERO/XMR中转矿池代理支持抽水,软件防CC,支持BTC/ETH/ETC/BCH/CFX/ERG/RVN/LTC/SERO/XMR无损耗抽水,支持TCP和SSL协议，支持自定义跨矿池抽水，高性能高并发，支持web界面管理，不爆内存,全自动进程守护以及开机启动,配套本地隧道加密软件，修改矿池本地算力，ip黑
...
- [amtoaer/bing-bong](https://github.com/amtoaer/bing-bong) - bing bong是一个用于支持RSS订阅的QQ（？）机器人
...
- [soxft/serverStatus](https://github.com/soxft/serverStatus) - a simple serverStatus mointor
...
- [naiba/solitudes](https://github.com/naiba/solitudes) - :rocket: 一个专注专栏写作的博客引擎
...
- [xbmlz/db-doc](https://github.com/xbmlz/db-doc) - 📝一款生成在线/离线数据库文档的小工具
...
- [Mtoly/V2boardLoadingPageTheme](https://github.com/Mtoly/V2boardLoadingPageTheme) - v2board面板的落地页主题，修改自whmcs主题
- [insoxin/html5-speedtest](https://github.com/insoxin/html5-speedtest) - 一个基于HTML5的Speedtest 开源速度测试(服务器网速)只有9kb的精简汉化
- [KSKBpage/dn42page](https://github.com/KSKBpage/dn42page) - DN42 page
- [renbaoshuo/dn42-site](https://github.com/renbaoshuo/dn42-site) - 
...
- [llorephie/ngx-fancyindex-theme-bootstrap](https://github.com/llorephie/ngx-fancyindex-theme-bootstrap) - Bootstrap theme for NGINX Fancyindex module
- [malaohu/GitHubHosts](https://github.com/malaohu/GitHubHosts) - 轻松解决国内无法访问Github的囧境
...
- [5iux/5iux.github.io](https://github.com/5iux/5iux.github.io) - 5iux.github.io
...
- [kphcdr/godoc](https://github.com/kphcdr/godoc) - go语言版本的 showdoc
- [SuLingGG/apindex-v3](https://github.com/SuLingGG/apindex-v3) - Static HTML file index generator for Github Pages
...
- [rockuw/oss-in-browser](https://github.com/rockuw/oss-in-browser) - Play with OSS, right in browser!
- [moi-mo/UMPaper](https://github.com/moi-mo/UMPaper) - 基于UMaize Jekyll主题的，为文本阅读优化的版本
...
- [skyzh/skyzh-site](https://github.com/skyzh/skyzh-site) - Alex Chi's personal site
- [xiaolai/apple-computer-literacy](https://github.com/xiaolai/apple-computer-literacy) - 个人电脑使用（以苹果产品为例）
- [WhaleFell/SkyDailyTask](https://github.com/WhaleFell/SkyDailyTask) - Sky光遇每日任务攻略自动更新，自动推送邮箱，再也不怕崽崽不会做每日任务啦啦啦！！！【利用爬虫实现】
...
- [anbang/javascript-notes](https://github.com/anbang/javascript-notes) - 朱安邦的 JavaScript 学习笔记；JavaScript学习总结；前端变化太快，只有把JS基础打扎实了，才能游刃有余；为了让我的JavaScript基础异常牢固，思路更加清晰，我会把以前总结过的知识和平时看到的资料放在这里，把以前零零散散的知识点全部串起来！这个项目也许写到最后会是一个非常不错的JavaScript教程，希望可以帮到更多的人；收藏请点star；如果发现我有写错误的，欢迎随时帮
...
- [FrpcCluster/frpc-Android](https://github.com/FrpcCluster/frpc-Android) - Android,安卓版frpc，一个快速反向代理，可帮助您将NAT或防火墙后面的本地服务器暴露给Internet。
...
- [wlcoder/ms-notify](https://github.com/wlcoder/ms-notify) - 定时发送邮件
...
- [xu-fucheng/fufile](https://github.com/xu-fucheng/fufile) - Distributed File System
...
- [Stapxs/Stapxs-Web-API](https://github.com/Stapxs/Stapxs-Web-API) - 这是 SS 的 API！
...
- [1n7erface/sendMail](https://github.com/1n7erface/sendMail) - 批量发送钓鱼邮箱
...
- [201206030/novel](https://github.com/201206030/novel) - novel 是一套基于时下最新 Java 技术栈 Spring Boot 3 + Vue 3 开发的前后端分离学习型小说项目，配备详细项目开发文档，由小说门户系统、作家后台管理系统、平台后台管理系统等多个子系统构成。包括小说推荐、作品检索、小说排行榜、小说阅读、小说评论、会员中心、作家专区、充值订阅、新闻发布等功能。
...
- [ZHENFENG13/My-Blog](https://github.com/ZHENFENG13/My-Blog) - :palm_tree::octocat:A simple & beautiful blogging system implemented with spring-boot & thymeleaf & mybatis My Blog 是由 SpringBoot + Mybatis + Thymeleaf 等技术实现的 Java 博客系统，页面美观、功能齐全、部署简单及完善的代码，一定会给使用者无与伦
...
- [huxiaoxu2019/hestia-server](https://github.com/huxiaoxu2019/hestia-server) - For smart-home. In Ancient Greek religion, Hestia (/ˈhɛstiə/; Greek: Ἑστία, "hearth" or "fireside") is a virgin goddess of the hearth, architecture, and the right ordering of domesticity, the family, 
- [ddsbear/AnyTool](https://github.com/ddsbear/AnyTool) - :fire: Android various tool classes, make your development faster and easier.     Android各种工具类，让你的开发更快更简单
...
- [taffychan/x-ui](https://github.com/taffychan/x-ui) - 
- [clean-css/clean-css](https://github.com/clean-css/clean-css) - Fast and efficient CSS optimizer for node.js and the Web
- [StartBootstrap/startbootstrap-heroic-features](https://github.com/StartBootstrap/startbootstrap-heroic-features) - A Bootstrap HTML homepage template with feature boxes - created by Start Bootstrap
...
- [wyzda/SerachC3_bot](https://github.com/wyzda/SerachC3_bot) - Telegram C3pool 机器人
- [cxumol/tg-search](https://github.com/cxumol/tg-search) - Search in Telegram with CJT words (unofficial). Telegram 中文搜索 (非官方).
...
- [ChenYFan/R2Worker](https://github.com/ChenYFan/R2Worker) - 
...
- [XMRWallet/Website](https://github.com/XMRWallet/Website) - Website development for XMRWallet
...
- [felixrieseberg/onedrive-link](https://github.com/felixrieseberg/onedrive-link) - Generate direct download links for OneDrive
- [colmugx/hexo-theme-Nlvi](https://github.com/colmugx/hexo-theme-Nlvi) - 🎨A simple theme for hexo.
...
- [ponponon/whoisface](https://github.com/ponponon/whoisface) - 基于树莓派的人脸识别系统设计
...
- [VirgilClyne/GetSomeFries](https://github.com/VirgilClyne/GetSomeFries) - 整点薯条
...
- [rockuw/node-sts-app-server](https://github.com/rockuw/node-sts-app-server) - Node.js STS App Server
- [TMaize/tmaize-blog](https://github.com/TMaize/tmaize-blog) - 一款jekyll主题，简洁纯净，支持自适应，支持夜间模式
...
- [Volcomix/500wallpaper](https://github.com/Volcomix/500wallpaper) - CLI to download wallpapers and lock screens from 500px website.
- [aloeJun/hexo-themes-matery-pro](https://github.com/aloeJun/hexo-themes-matery-pro) - 基于matery主题魔改的hexo主题博客源码
...
- [yuxiaoy1/nonstop](https://github.com/yuxiaoy1/nonstop) - Nonstop 是一个 chrome 扩展，用于无感跳转到知乎，微博，掘金，豆瓣，CSDN，简书，QQ 邮箱等无法直接跳转的外链，免去手动跳转的烦恼。
...
- [DemoMacro/hexo-boilerplate-netlify-cms](https://github.com/DemoMacro/hexo-boilerplate-netlify-cms) - Hexo boilerplate integrated with Netlify CMS, powered by Demo Macro.
...
- [cddqssc/WeTypecho](https://github.com/cddqssc/WeTypecho) - 微信小程序版Typecho
...
- [mumuy/relationship](https://github.com/mumuy/relationship) - Chinese kinship system.中国亲戚关系计算器 - 家庭称谓/亲戚称呼/称呼计算/亲戚关系算法/親戚稱呼計算機
...
- [hugetiny/decenter](https://github.com/hugetiny/decenter) - All-in-one downloader based on Aria2 全能下载器
...
- [vizhub-core/codemirror-ot](https://github.com/vizhub-core/codemirror-ot) - Real-time collaboration plugin for CodeMirror 6.
...
- [HelipengTony/oblog](https://github.com/HelipengTony/oblog) - A MDX :arrow_down_small: based Blog Engine
- [HelipengTony/eugrade](https://github.com/HelipengTony/eugrade) - All-in-one :school: Learning Management System
...
- [iDestin/Himalayan-lite](https://github.com/iDestin/Himalayan-lite) - 这是一个模仿喜马拉雅lite的微信小程序 - 简单易上手
...
- [Whale0804/Giteer](https://github.com/Whale0804/Giteer) - Giteer For 码云，基于Taro + Taro UI + Dva的小程序。
...
- [zhimengzhe/iBarn](https://github.com/zhimengzhe/iBarn) - iBarn SkyDrive provides file network backup, synchronization and sharing service. This system can resume upload and down file and if someone uploads one file when you upload it too, it needn't upload 
...
- [KOHGYLW/kiftd](https://github.com/KOHGYLW/kiftd) - sky driver & cloud driver open source server application : kiftd . welcome to the home page: https://kohgylw.gitee.io/ to quick start——kiftd是一款专门面向个人、团队和小型组织的私有网盘系统。轻量、开源、完善。无论是在家庭、学校还是在办公室，您都能立刻开始使用它
...
- [TdBotProject/TdPmBot](https://github.com/TdBotProject/TdPmBot) - Telegram 全功能私聊机器人
...
- [typora/support.typora.io](https://github.com/typora/support.typora.io) - Support site for Markdown Editor Typora
...
- [leighmcculloch/AppSandboxFileAccess](https://github.com/leighmcculloch/AppSandboxFileAccess) - A class that wraps up writing and accessing files outside a Mac apps App Sandbox files into a simple interface. The class will request permission from the user with a simple to understand dialog consi
...
- [moesoha/bird-bgp-kickstart](https://github.com/moesoha/bird-bgp-kickstart) - [Chinese] 给想使用 BIRD 配置 BGP 的新手一个教程。
- [Ryeeeeee/MarkdownX](https://github.com/Ryeeeeee/MarkdownX) - Markdown text editor for Android
- [BluemediaGER/dn42-home](https://github.com/BluemediaGER/dn42-home) - Homepage for bluemedia.dn42, my personal network within DN42.
- [kiwibrowser/src](https://github.com/kiwibrowser/src) - Source-code used in Kiwi Browser for Android
- [httpie/desktop](https://github.com/httpie/desktop) - 🚀 Releases of HTTPie for Desktop. Get early access: https://httpie.io/beta
- [zdotsh/git-io-replace](https://github.com/zdotsh/git-io-replace) - We offer a free replace with your old git.io URLs.
- [IonicaBizau/msdos-editor-vs-theme](https://github.com/IonicaBizau/msdos-editor-vs-theme) - :tv: An MS-DOS Editor like theme for Visual Studio Code. It is blue.
...
- [iwayen/Azure-Helper](https://github.com/iwayen/Azure-Helper) - A bot to manager azure(global).  Made by @imwayen
...
- [lxgw/LxgwClearGothic](https://github.com/lxgw/LxgwClearGothic) - A Chinese sans-serif font derived from IPAex Gothic. 一款衍生于「IPAexゴシック」的中文黑体字型。
...
- [WooMaiLabs/WMBot-Docs](https://github.com/WooMaiLabs/WMBot-Docs) - Telegram @WooMaiBot 相关文档
...
- [dengxiuqi/ChineseLyrics](https://github.com/dengxiuqi/ChineseLyrics) - 10W首中文歌词数据库
...
- [helloxz/v2ex-luck](https://github.com/helloxz/v2ex-luck) - V2EX楼层抽奖
...
- [librarycloud/wikipedia-conf](https://github.com/librarycloud/wikipedia-conf) - nginx conf for Wikipedia wikipmedia 维基百科、维基媒体全站反代
...
- [juiceRv/JuiceVm](https://github.com/juiceRv/JuiceVm) - The juice virtual machine was born in 2020, with the goal of realizing the smallest virtual machine of RISC-V that can run the latest kernel mainline. At the beginning of the design, it runs on a plat
...
- [Heroic-Studio/Google-Mirrors](https://github.com/Heroic-Studio/Google-Mirrors) - Google谷歌、Wikipedia维基百科、谷歌学术镜像2022最新 新增各种镜像站
...
- [NeroGizmoUwU/Github-Desktop-Armhf](https://github.com/NeroGizmoUwU/Github-Desktop-Armhf) - 
...
- [kidonng/sushi](https://github.com/kidonng/sushi) - [Unmaintained] 🍣 A tasty and inclusive Scoop bucket
...
- [xiaoming-ssr/FanQiang-Book](https://github.com/xiaoming-ssr/FanQiang-Book) - 【2022】科学上网、机场梯子，小白图文攻略 | 翻墙/梯子/自由上网/SSR/V2Ray/
...
- [moeshin/Typecho-Theme-Littlehands](https://github.com/moeshin/Typecho-Theme-Littlehands) - 一款基于 Typecho 原生主题修改的主题
- [typecho/typecho](https://github.com/typecho/typecho) - A PHP Blogging Platform. Simple and Powerful.
- [flucont/btcloud](https://github.com/flucont/btcloud) - 一个宝塔第三方云端的php站点程序
- [gmajian/sandphoto](https://github.com/gmajian/sandphoto) - Layout ID/VISA photos in a single 6-inch photo 证件照片排版在线生成器 - 在一张6寸的照片上排版多张证件照
...
- [Rodots/WHMCS-zh-CN](https://github.com/Rodots/WHMCS-zh-CN) - WHMCS系统7.9.2-8.5.0前后台简体中文汉化
- [loliart-lae/lae](https://github.com/loliart-lae/lae) - Open App Engine (摆烂了)
- [Seevil/fantasy](https://github.com/Seevil/fantasy) - 一款极简Typecho 博客主题
...
- [JaydenForYou/Spring](https://github.com/JaydenForYou/Spring) - 响应式TYPECHO主题
- [hanximeng/LanzouAPI](https://github.com/hanximeng/LanzouAPI) - 蓝奏云直链，蓝奏api，蓝奏解析，蓝奏云解析API，蓝奏云带密码解析
- [soxft/UrlShorter](https://github.com/soxft/UrlShorter) - A simple but powerful URL shortener
- [ChaosJohn/ddns-dnspod](https://github.com/ChaosJohn/ddns-dnspod) - ddns for dnspod.cn which supports both IPv4 and IPv6
...
- [guanguans/notify](https://github.com/guanguans/notify) - 推送通知 sdk(Bark、Chanify、钉钉群机器人、Discord、邮件、飞书群机器人、Gitter、Google Chat、iGot、Logger、Mattermost、Now Push、PushBack、Push、PushDeer、PushPlus、QQ 频道机器人、Rocket Chat、Server 酱、Showdoc Push、Slack、Telegram、Webhook、企业微信
...
- [php4dev/heroku-wordpress](https://github.com/php4dev/heroku-wordpress) - Template project for deploying WordPress 5.7.2 to Heroku
...
- [iRoZhi/Typecho-vCards-theme](https://github.com/iRoZhi/Typecho-vCards-theme) - 一款简约的vcard主题-typecho
...
- [weipxiu/Art_Blog](https://github.com/weipxiu/Art_Blog) - WordPress响应式免费主题，Art_Blog唯品秀博客（weipxiu.com），开源给小伙伴免费使用，如使用过程有任何问题，在线技术支持QQ:343049466，欢迎打扰。原创不易，如喜欢，请多多打赏。演示：
...
- [HelipengTony/tony](https://github.com/HelipengTony/tony) - An Elegant WordPress Theme Powered by :v:Vue.js 2
...
- [StartBootstrap/startbootstrap-modern-business](https://github.com/StartBootstrap/startbootstrap-modern-business) - A multipurpose Bootstrap full website template created by Start Bootstrap
- [StartBootstrap/startbootstrap-business-frontpage](https://github.com/StartBootstrap/startbootstrap-business-frontpage) - A Bootstrap HTML business homepage template created by Start Bootstrap
- [StartBootstrap/startbootstrap-blog-post](https://github.com/StartBootstrap/startbootstrap-blog-post) - A Bootstrap HTML template for blog posts - created by Start Bootstrap
...
- [random-yang/paper](https://github.com/random-yang/paper) - 一个类纸风的主题paper 🎉 (基本不再更新)
...
- [liyongqi2002/Email_Client](https://github.com/liyongqi2002/Email_Client) - 从socket开始实现pop3和smtp客户端，实现邮件编写、发送、接收、阅读、删除等基本功能。并实现简单界面（Python+PyQt5）
- [Moemu/GetBingImg](https://github.com/Moemu/GetBingImg) - 获取当天或指定一天的Bing美图，支持查询同一月内Bing美图信息
- [borisdayma/dalle-mini](https://github.com/borisdayma/dalle-mini) - DALL·E Mini - Generate images from a text prompt
- [Ailitonia/omega-miya](https://github.com/Ailitonia/omega-miya) - 基于nonebot2的qq机器人
- [chn-lee-yumi/miniCloud](https://github.com/chn-lee-yumi/miniCloud) - An mini cloud platform (for virtual machines).
- [anasty17/mirror-leech-telegram-bot](https://github.com/anasty17/mirror-leech-telegram-bot) - Official Repository
- [insorasky/dn42peerbot](https://github.com/insorasky/dn42peerbot) - DN42 Autopeering Telegram Bot
...
- [lutoma/autopeer](https://github.com/lutoma/autopeer) - Self-service portal for DN42 peerings
...
- [fslongjin/CleanDNS](https://github.com/fslongjin/CleanDNS) - A tiny local Clean DNS Server
- [fslongjin/This-repo-has-1246-stars](https://github.com/fslongjin/This-repo-has-1246-stars) - 这个仓库有1246个star，不信你试试
- [touuki/colymer-acquirers](https://github.com/touuki/colymer-acquirers) - 各种爬虫（目前支持Instagram、Weibo、Twitter）Miscellaneous crawlers (currently including instagram, twitter, weibo etc.).
...
- [realByg/digitalocean-helper-bot](https://github.com/realByg/digitalocean-helper-bot) - 用 telegram bot 管理 Digital Ocean 账号
- [CollegesChat/university-information](https://github.com/CollegesChat/university-information) - 收集全国各高校招生时不会写明，却会实实在在影响大学生活质量的要求与细节
- [2Dou/watermarker](https://github.com/2Dou/watermarker) - 使用python脚本为图片添加文字水印
- [realByg/azure-helper-bot](https://github.com/realByg/azure-helper-bot) - 用 telegram bot 管理 Azure 虚拟机
...
- [Tmitsuha/panel](https://github.com/Tmitsuha/panel) - 
- [vzemtsov/ssh-Connection-In-Telegram](https://github.com/vzemtsov/ssh-Connection-In-Telegram) - Ssh connection in telegram-bot
...
- [HFrost0/bilix](https://github.com/HFrost0/bilix) - ⚡️快如闪电的bilibili下载工具，基于Python现代Async特性，高速批量下载整部动漫，电视剧，up投稿等
...
- [rucarrol/traceflow](https://github.com/rucarrol/traceflow) - A pure python interpretation of traceroute
...
- [Biel-Hammer/IDphoto](https://github.com/Biel-Hammer/IDphoto) - 一寸证件照制作
- [zaxlct/imooc-django](https://github.com/zaxlct/imooc-django) - 高仿慕课网：py3.5 + Django1.10 + xadmin 搭建的在线课程教育平台
- [du5/speedtest-cli](https://github.com/du5/speedtest-cli) - Command line interface for testing internet bandwidth using speedtest.net
...
- [heimoshuiyu/lottery-assistant](https://github.com/heimoshuiyu/lottery-assistant) - Tkinter 抽签助手 For python3 标准库
- [BlueSkyXN/CCATK](https://github.com/BlueSkyXN/CCATK) - 高度自动化CC脚本
- [ckcoding/ip_Pool](https://github.com/ckcoding/ip_Pool) - ip池代理，适用于爬虫，刷阅读量，刷推广，刷访问量等
...
- [liuli-io/liuli](https://github.com/liuli-io/liuli) - 一站式构建多源、干净、个性化的阅读环境(Build a multi-source, clean and personalized reading environment in one stop.)
...
- [qiandao-today/qiandao](https://github.com/qiandao-today/qiandao) - [当前版本: 20220525] 新版自动签到开源框架, binux/qiandao基础上添加完善各项功能，并适配Python3
...
- [multiSnow/mcomix3](https://github.com/multiSnow/mcomix3) - please use the original mcomix (https://sourceforge.net/projects/mcomix/)
...
- [ybdt/dict-hub](https://github.com/ybdt/dict-hub) - 口令攻击
...
- [sheepzh/poetry](https://github.com/sheepzh/poetry) - 汉语现代诗歌语料库整理，3452诗人，80.9K诗歌，15.28M字。持续扩充...
...
- [IngoMeyer441/pyDailyChanger](https://github.com/IngoMeyer441/pyDailyChanger) - pyDailyChanger is a program that changes your wallpaper daily. Additionally, a small calendar can be displayed. It's runnable on various systems as Windows, Mac OS X and Linux with several desktop env
...
- [spiritLHLS/ecs](https://github.com/spiritLHLS/ecs) - 融合怪测评脚本(测评频道：https://t.me/vps_reviews )(脚本未完善，点star就好了，fork属实没啥必要)
- [emptysuns/Hi_Hysteria](https://github.com/emptysuns/Hi_Hysteria) - Hello World！非钟国优化线路使用不佳？不想中转？hysteria一键搞定。
- [veip007/EUserv-warp](https://github.com/veip007/EUserv-warp) - EUserv德鸡IPV6 VPS添加WARP双栈IPV6+IPV4、WARP单IPV4一键脚本，针对OpenVZ、LXC架构的IPV6 only VPS
- [Hinara/linux-vm-tools](https://github.com/Hinara/linux-vm-tools) - Hyper-V Linux Guest VM Enhancements
- [wy580477/Cloudreve-slave-on-Heroku](https://github.com/wy580477/Cloudreve-slave-on-Heroku) - 在Heroku上部署Cloudreve从机离线下载节点
...
- [fcurrk/reinstall](https://github.com/fcurrk/reinstall) - 
- [qinghuas/alidns-bash](https://github.com/qinghuas/alidns-bash) - 使用阿里云提供的api，管理在阿里云购买的域名。支持增删查改等基本操作，以及配合crontab实现自建ddns的bash脚本
- [EtherDream/anti-portscan](https://github.com/EtherDream/anti-portscan) - 使用 iptables 防止端口扫描
- [SoftCreatR/warp-up](https://github.com/SoftCreatR/warp-up) - Automatically generated referrer bonuses for Cloudflare WARP (https://1.1.1.1)
...
- [spiritLHLS/lxc](https://github.com/spiritLHLS/lxc) - 母鸡开小鸡，一键多开小鸡，一键多开NAT小鸡，一键LXC虚拟化，一键多开服务器，多开容器，一键多开NAT小鸡，一键多开NAT服务器。(初始化只需几分钟，开小鸡等待时长和数量有关)(免费服务器)
...
- [ibisheng/deploy](https://github.com/ibisheng/deploy) - onlyoffice 一键安装 ：毕升文档包括drive和在线文件服务功能。其中drive实现文件的在线管理，组织结构权限，分享，团队协作等，文件的全文检索等功能；在线文件服务能够处理word,ppt,excel格式文件的带水印预览以及多人协同编辑，另外还能处理pdf，视频，音频文件的预览以及实现了100多种文本文件带语法高亮的预览
...
- [BlueSkyXN/ChangeSource](https://github.com/BlueSkyXN/ChangeSource) - 为LInux系统一键更换软件源的一键脚本和其他替换源/备用镜像的常用脚本
...
- [ChenYFan/CheckSSL](https://github.com/ChenYFan/CheckSSL) - :lock:Check your site's SSL status using curl & bash
...
- [UtermuxBlog/termux-android5-repo](https://github.com/UtermuxBlog/termux-android5-repo) - Foreign source of termux below Android 6
...
- [glasnostlinux/glasnost](https://github.com/glasnostlinux/glasnost) - An experimental Linux distribution based on KISS Linux. Runs on various architectures and allows cross-compilation.
...
- [jacyl4/de_GWD](https://github.com/jacyl4/de_GWD) - Debian Gateway & DNS - &lt;Burst Link&gt;
...
- [bashbox/bashbox](https://github.com/bashbox/bashbox) - Bashbox is a wannabe bash compiler which aims to help create modular and maintainable bash projects. With added native beautification, formatting, optimization and syntax/error checking/handling(stack
...
- [Jerrywang959/notion-reverse-proxy](https://github.com/Jerrywang959/notion-reverse-proxy) - Notion Reverse Proxy for better speed in China Mainland
...
- [philcook/brew-php-switcher](https://github.com/philcook/brew-php-switcher) - Brew PHP switcher is a simple shell script to switch your apache and CLI quickly between major versions of PHP. If you support multiple products/projects that are built using either brand new or old l
...
- [leirock/blog](https://github.com/leirock/blog) - «Pinlyu» – Leirock's Blog
...
- [YukariChiba/TransPassport](https://github.com/YukariChiba/TransPassport) - 跨 国 护 照（迫真）。有了 passport 您就能 pass（逃
...
- [Roche/lxdhub](https://github.com/Roche/lxdhub) - Display, search and copy LXD images using a web interface.
- [MattieTK/vercel-dynamic-dns](https://github.com/MattieTK/vercel-dynamic-dns) - Tiny typescript daemon to update a subdomain managed in Vercel.com with the host's current IP
- [xianshenglu/cloudflare-ip-tester-app](https://github.com/xianshenglu/cloudflare-ip-tester-app) - 
- [186526/origin-finder](https://github.com/186526/origin-finder) - A small DNS Server simple (incomplete) implementation of origin.asn.cymru.com, using the API of ip.186526.xyz
...
- [realByg/ip.byg.dev](https://github.com/realByg/ip.byg.dev) - 
- [nrwl/nx](https://github.com/nrwl/nx) - Smart, Fast and Extensible Build System
- [pengfeiw/react-paint](https://github.com/pengfeiw/react-paint) - windows 画板 —— Microsoft Paint
...
- [SourceGlobalCDN/avatar-proxy](https://github.com/SourceGlobalCDN/avatar-proxy) - 综合头像服务系统，提供头像代理服务
- [AH-dark/ahdark.cn](https://github.com/AH-dark/ahdark.cn) - Profile website of AHdark
- [zonemeen/musicn](https://github.com/zonemeen/musicn) - 🎵 一个下载音乐的命令行工具
...
- [akirarika/project-maid](https://github.com/akirarika/project-maid) - 一款 Visual Studio Code 扩展，为开发与组织中大型项目，提供了一系列实用功能，All in One！
...
- [AtomAlpaca/Icalingua-clone](https://github.com/AtomAlpaca/Icalingua-clone) - Icalingua-2.4.5源代码，备份于2022年01月26日
- [AH-dark/toolbox](https://github.com/AH-dark/toolbox) - AHdark's Toolbox, provide simple services
...
- [LouisAndrew/vid2gif](https://github.com/LouisAndrew/vid2gif) - Simple video (mp4) to GIF converter.
...
- [lezi-wiki/zhksb-net](https://github.com/lezi-wiki/zhksb-net) - 张贺凯的个人主页
...
- [AH-dark/bing-image-api](https://github.com/AH-dark/bing-image-api) - Bing 壁纸API，使用Next.js编写
...
- [lutoma/dn42search](https://github.com/lutoma/dn42search) - A search engine for the DN42 overlay network
- [strexp/net-info](https://github.com/strexp/net-info) - 
...
- [HsOjo/dockore-frontend](https://github.com/HsOjo/dockore-frontend) - 
- [HelipengTony/nexment-vue](https://github.com/HelipengTony/nexment-vue) - Nexment for Vue, a serverless comment library
